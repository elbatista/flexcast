...
plot "skeen_12nodes_240cli_99%_gc0-ttlog.txt" using (($2)):xtic(1) t "Skeen"
...
set yrange [0:200]
set ytics (0, 100,200)
plot "skeen_12nodes_240cli_99%_gc0-ttlog.txt" using (($3)):xtic(1)
...
set yrange [0:50]
set ytics (0, 25,50)
plot "skeen_12nodes_240cli_99%_gc0-ttlog.txt" using (($2*$3/1024)):xtic(1)
