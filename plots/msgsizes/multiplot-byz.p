...
plot "byzcast_12nodes_720cli_99%_gc0-ttlog.txt" using (($2)):xtic(1) t "ByzCast"
...
set yrange [0:210]
set ytics (0, 100,200)
plot "byzcast_12nodes_720cli_99%_gc0-ttlog.txt" using (($3)):xtic(1)
...
set yrange [0:100]
set ytics (0, 50,100)
plot "byzcast_12nodes_720cli_99%_gc0-ttlog.txt" using (($2*$3/1024)):xtic(1)
